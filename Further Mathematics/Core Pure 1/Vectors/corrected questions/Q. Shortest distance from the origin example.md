...
It is better to take the unit vector in this format:
$$
d=\frac{\left|\vec{AB}\times  \vec{d}\right|}{|\vec{d}|}
$$
...
1+3\lambda \\
-7+8\lambda
\end{pmatrix} \qquad \left|\vec{AB}\right| = 3\sqrt{ 53 } \\ \\
...
3 \\
8
\end{pmatrix}\right|}{\sqrt{ 53 }} = \sqrt{ 6 }
\end{gather*}
$$
