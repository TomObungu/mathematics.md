Here are the non-multiple choice questions for A-Level Further Mathematics Core Pure 1 Matrices topic, formatted with `$$` and `$$$$` delimiters for Obsidian LaTeX Suite.
