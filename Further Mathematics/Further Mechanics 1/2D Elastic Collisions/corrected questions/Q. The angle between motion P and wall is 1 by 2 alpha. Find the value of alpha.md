...
For these types of questions involving half or double angles, you need to use either the double angle formulae or the angle addition formulae. When dealing with things in terms of $\frac{1}{2}\theta$ always try get everything in terms of $\frac{1}{2}\theta$ then substitute $t=\tan / \sin / \cos\frac{1}{2}\theta$ then solve in terms of $t$

Firstly set up the diagram for scenario:
