...
\begin{gather*}
\text{First collision :} \\ 
v_{1}\cos \alpha = 6\cos 45 \ (1)\\ 
v_{1}\sin \alpha = e6\sin 45 = \frac{1}{3}(6)\sin 45 \ (2) =  2\sin 45\\ \\
\frac{(2)}{(1)} \implies \tan\alpha =  \frac{2\sin 45}{6\cos 45} = \frac{1}{3} \\ \\ 
\therefore \alpha = \arctan\left( \frac{1}{3} \right) = 18.43^\circ
\end{gather*}
$$
