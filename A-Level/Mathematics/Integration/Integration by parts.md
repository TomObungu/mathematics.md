...
This means the higher the function is in the list, the more priority it takes in setting the value as your $u$ variable. In general try and avoid setting your value to trigonometric and exponential functions as they are infinitley differentiable
